...
Here we can see that pot 80 is open, which is the typical website port. Here I use "dirb" to do a basic directory scan (Other scanners and wordlists are available, but this is good to demonstrate for this easy case):
