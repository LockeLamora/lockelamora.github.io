...
It was also my first time soldering both pl259 and s0239 connectors, the videos I used are [here for the PL259](https://www.youtube.com/watch?v=DWIKgI62M_8) and [here for the SO239](https://www.youtube.com/watch?v=96CqtaKS0Qg).

What you can't see is the internal wiring of the coax to the loops, but this just follows the same map given on John Coppens's page given earlier.
...
I've also been able to reliably receive telemtry from some of the lower power satellites such as PSAT-1, though its output is shwoing its APRS digipeater as being turned off for now.
