...
The apache conf file is in a different place in freebsd, so we find it with this:
...
https://www.exploit-db.com/exploits/21665/ has a vuln for phptax, we need to try to get a shell through there
...
[<img src="{{ site.baseurl }}/images/kioptrix5/6.png"
 ...
 [<img src="{{ site.baseurl }}/images/kioptrix5/7.png"
  ...
  I found an exloit for this here:
