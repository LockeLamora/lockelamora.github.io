---
layout: post
title: Hackfest2016 Sedna VM Walkthrough
---
...
This exploit: https://www.exploit-db.com/exploits/40390/ looks promising for builderengine, So I just the PoC code to upload my favourite reverse webshell:
...
I tried a few different means of privilege escalation; there was supposedly one for Tomcat which was installed on the server but I couldn't get that to work, there were also a few present for the kernel version but no luck there either. In the end I went for the nuclear option and execute the dirtycow exploit. This is a very effective but pretty unstable solution; it can freeze the OS in a few seconds but for the purposes of this VM that was enough to grab a flag:

[<img src="{{ site.baseurl }}/images/sedna/8.png"
    style="width: 800px;"/>]({{ site.baseurl }}/images/sedna/8.png)
