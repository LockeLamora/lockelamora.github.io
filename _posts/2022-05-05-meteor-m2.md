...
The image still turned out better than I thought. I was using the GUI version of satdump and had it set to live processing, and the amount of images it outputs automatically is so impressive. Here's my favourite from my first pass over the UK:
...
The benefits of it being live processing is that I can leave it unattended for an hour or so while I have to eave the house to take my daughter to nursery and the filesizes aren't greedy at all, usually around 2mb! if I was to try that with NOAA it'd be a few hundred mb at least.
