...
So I grab the exploit tar file from https://www.exploit-db.com/exploits/26474/ and upload this to the server using the php file manager again, then chmod the compile shell script to 777, compile and run:
