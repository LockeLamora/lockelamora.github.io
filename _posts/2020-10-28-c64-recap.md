...
I've been re-organising things during lockdown and doing some much-needed chores around the house and garden, And now it's the Commodore 64's turn; How to make this console from the 80s last another 25 years.
...
[<img src="{{ site.baseurl }}/images/c64-recap/4.png"
 style="width: 300px;"/>]({{ site.baseurl }}/images/c64-recap/4.png)
...
The areas in green will be the more hardworking chips we're going to heatsink.

[<img src="{{ site.baseurl }}/images/c64-recap/5.png"
  style="width: 300px;"/>]({{ site.baseurl }}/images/c64-recap/5.png)
...
[<img src="{{ site.baseurl }}/images/c64-recap/6.jpg"
   style="width: 300px;"/>]({{ site.baseurl }}/images/c64-recap/6.jpg)  
...
Also that in my opinion a sucker (Mine is just  handheld spring powered version) is in my opinion the easiest way of desoldering and removing components, I tried with braid  and although I suppose it'll work in a pinch it's not my cup of tea at all.

So here's how the board looks with the new capacitors:

[<img src="{{ site.baseurl }}/images/c64-recap/7.jpg"
   style="width: 300px;"/>]({{ site.baseurl }}/images/c64-recap/7.jpg)  

and after a clean with isoproyl alcohol and some heatsinks attached:

[<img src="{{ site.baseurl }}/images/c64-recap/8.jpg"
   style="width: 300px;"/>]({{ site.baseurl }}/images/c64-recap/8.jpg)   
