---
layout: post
title: hackfest2016: Quaoar VM Walkthrough
---
...
When we visit the wordpress site, the existing post there is attributed to the user "admin". Changing the author profile URL to "author=2" doesn't bring any new accounts p so it looks like it's just the admin one there, as we can see below with a random username wordpress helpfully tells us it doesn't exist. Since 'admin' doesn't get this error we know it's fine.
